...
// Dynamically construct JS wrapper with custom static imports and named
// exports. Boots up an internal worker to resolve imports/exports through query
// from V8.
...
impl WasmCompiler {
	/// Create a new V8 worker with snapshot of WASM compiler and setup
	/// compiler's runtime.
