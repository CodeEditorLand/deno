...
test(function textDecoderIgnoreBOM(): void {
	// prettier-ignore
	const fixture = new Uint8Array([
		0xef, 0xbb, 0xbf, 0xf0, 0x9d, 0x93, 0xbd, 0xf0, 0x9d, 0x93, 0xae, 0xf0,
		0x9d, 0x94, 0x81, 0xf0, 0x9d, 0x93, 0xbd,
	]);
...
test(function textDecoderNotBOM(): void {
	// prettier-ignore
	const fixture = new Uint8Array([
		0xef, 0xbb, 0x89, 0xf0, 0x9d, 0x93, 0xbd, 0xf0, 0x9d, 0x93, 0xae, 0xf0,
		0x9d, 0x94, 0x81, 0xf0, 0x9d, 0x93, 0xbd,
	]);
	const decoder = new TextDecoder("utf-8", { ignoreBOM: true });
...
test(function textEncoder(): void {
	...
	assertEquals(
		...
		[
			0xf0, 0x9d, 0x93, 0xbd, 0xf0, 0x9d, 0x93, 0xae, 0xf0, 0x9d, 0x94,
			0x81, 0xf0, 0x9d, 0x93, 0xbd,
		],
	);
});
...
test(function textEncodeInto(): void {
	...
	// prettier-ignore
	assertEquals(Array.from(bytes), [0x74, 0x65, 0x78, 0x74, 0x00]);
});
