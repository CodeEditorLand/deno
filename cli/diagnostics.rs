...
impl Error for Diagnostic {
	fn description(&self) -> &str { &self.items[0].message }
}
...
pub struct DiagnosticItem {
	...
	/// A chain of messages, code, and categories of messages which indicate
	/// the full diagnostic information.
	pub message_chain:Option<DiagnosticMessageChain>,

	/// Other diagnostic items that are related to the diagnostic, usually
	/// these are suggestions of why an error occurred.
