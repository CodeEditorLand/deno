...
fn op_worker_get_message(
	...
	let op = GetMessageFuture { state:state.clone() };
...
fn op_create_worker(
	...
	// and block on receving message on a channel or even use sync channel
	// /shrug
...
fn op_host_get_worker_closed(
	...
	let future = GetWorkerClosedFuture { state:state.clone(), rid:id };
