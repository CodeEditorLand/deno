...
impl deno_buf {
	#[inline]
	pub fn empty() -> Self { Self { data_ptr:null(), data_len:0 } }

	#[inline]
	pub unsafe fn from_raw_parts(ptr:*const u8, len:usize) -> Self {
		Self { data_ptr:ptr, data_len:len }
	}
}
...
type deno_recv_cb = unsafe extern fn(
...
/// the module.
#[allow(non_camel_case_types)]
type deno_dyn_import_cb = unsafe extern fn(
	user_data:*mut c_void,
