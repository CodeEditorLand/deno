...
// by the privileged side of Deno to refer to various rust objects that need to
// be referenced between multiple ops. For example, network sockets are
// resources. Resources may or may not correspond to a real operating system
// file descriptor (hence the different name).

use std::{self, any::Any, collections::HashMap};

use downcast_rs::Downcast;

/// ResourceId is Deno's version of a file descriptor. ResourceId is also
/// referred to as rid in the code base.
