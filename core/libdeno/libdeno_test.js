...
this.JSSendArrayBufferViewTypes = () => {
	...
	const u32 = new Uint32Array(
		ab2,
		2468,
		1000 / Uint32Array.BYTES_PER_ELEMENT,
	);
	u32[0] = 0x02020202;
...
this.LibDenoEvalContextInvalidArgument = () => {
	try {
...
this.LibDenoPrintInvalidArgument = () => {
	try {
		Deno.core.print();
	} catch (e) {
		assert(e instanceof TypeError);
